...
function Navbar() {
    ...
    return (
        <div>
            <nav className='fixed w-full z-20 top-0 bg-orange-100 bg-opacity-80'>
                <div className=' max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2'>
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQINBiirUJE-3iQzsQm3T9_uCx3QdHr-W1PopV6h49H-A&s" className=' h-8 ml-4' alt='LOGO' />
       ...
       md:space-x-8 md:mt-0 md:border-0 ${isOpen ? 'bg-orange-100 bg-opacity-70' : ''
                            } `}>
