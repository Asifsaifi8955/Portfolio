        ...
        <div>
            <div className='flex-row items-center pl-5 justify-center pt-3 ' id='Overview'>
                ...
                <div className={Styles.sectionText}>
                    I'm a skilled web developer with experiences in JavaScript, Java and expertise in frameworks like React, Node.js I'm a
                    quick learner and collaborate, scalable and user-friendly solutions that solve real-world problems. Let's work
